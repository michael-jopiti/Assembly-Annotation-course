...
#SBATCH --job-name=EDTA_corrected
#SBATCH --mail-user=michael.jopiti@unifr.ch
#SBATCH --mail-type=start,end
#SBATCH --output=/data/users/mjopiti/annotation-course/script/outputs/EDTA_output_%j.o
#SBATCH --error=/data/users/mjopiti/annotation-course/script/errors/EDTA_error_%j.e
